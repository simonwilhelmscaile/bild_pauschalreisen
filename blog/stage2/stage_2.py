...
try:
    ...
    # build_image_prompt was refactored; hero images now use build_beurer_hero_prompt
    # This fallback prevents pipeline crash when images are skipped
    def build_image_prompt(keyword, company_data, language, position, visual_identity=None):
        return f"Professional health and wellness photo related to {keyword}, {position} position"
