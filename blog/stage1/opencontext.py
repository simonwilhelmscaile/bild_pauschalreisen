...
async def run_opencontext(url: str, api_key: Optional[str] = None) -> CompanyContext:
    ...
    Uses core GeminiClient with URL Context + Google Search grounding.
    ...
    try:
        ...
        # Call with Google Search grounding
        # Note: url_context (browse tool) is disabled as it requires Vertex AI
